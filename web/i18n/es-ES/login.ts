const translation = {
  ...
  welcome: 'Bienvenido a Haufe-group, por favor inicia sesión para continuar.',
  ...
  license: {
    tip: 'Antes de comenzar con Haufe-group Community Edition, lee la',
    link: 'Licencia de código abierto de GitHub',
  },
  join: 'Unirse',
  joinTipStart: 'Te invita a unirte al equipo de',
  joinTipEnd: 'en Haufe-group',
  invalid: 'El enlace ha expirado',
  explore: 'Explorar Haufe-group',
