const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Cuenta Haufe-group',
    langGeniusAccountTip: 'Tu cuenta Haufe-group y los datos de usuario asociados.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitación enviada, y pueden iniciar sesión en Haufe-group para acceder a tus datos del equipo.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'El servicio de hospedaje OpenAI proporcionado por Haufe-group te permite usar modelos como GPT-3.5. Antes de que se agote tu cuota de prueba, necesitas configurar otros proveedores de modelos.',
  ...
  apiBasedExtension: {
    title: 'Las extensiones basadas en API proporcionan una gestión centralizada de API, simplificando la configuración para su fácil uso en las aplicaciones de Haufe-group.',
  ...
  about: {
    ...
    nowAvailable: 'Haufe-group {{version}} ya está disponible.',
    latestAvailable: 'Haufe-group {{version}} es la última versión disponible.',
  },
  appMenus: {
    overview: 'Monitoreo',
    promptEng: 'Orquestar',
