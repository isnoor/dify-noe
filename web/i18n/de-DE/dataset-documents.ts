const translation = {
  list: {
    title: 'Dokumente',
    desc: 'Alle Dateien des Wissens werden hier angezeigt, und das gesamte Wissen kann mit Haufe-group-Zitaten verknüpft oder über das Chat-Plugin indiziert werden.',
    ...
    empty: {
      ...
      sync: {
        tip: 'Haufe-group wird periodisch Dateien von Ihrem Notion herunterladen und die Verarbeitung abschließen.',
      },
    },
    delete: {
