const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Wavelr-Konto',
    langGeniusAccountTip: 'Ihr Wavelr-Konto und zugehörige Benutzerdaten.',
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet, und sie können sich bei Wavelr anmelden, um auf Ihre Teamdaten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der OpenAI-Hostingdienst von Wavelr ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  apiBasedExtension: {
    title: 'API-Erweiterungen bieten zentralisiertes API-Management und vereinfachen die Konfiguration für eine einfache Verwendung in Wavelrs Anwendungen.',
  ...
  about: {
    ...
    nowAvailable: 'Wavelr {{version}} ist jetzt verfügbar.',
    latestAvailable: 'Wavelr {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',
