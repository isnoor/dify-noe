const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Haufe-group-Konto',
    langGeniusAccountTip: 'Ihr Haufe-group-Konto und zugehörige Benutzerdaten.',
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet, und sie können sich bei Haufe-group anmelden, um auf Ihre Teamdaten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der OpenAI-Hostingdienst von Haufe-group ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  apiBasedExtension: {
    title: 'API-Erweiterungen bieten zentralisiertes API-Management und vereinfachen die Konfiguration für eine einfache Verwendung in Haufe-groups Anwendungen.',
  ...
  about: {
    ...
    nowAvailable: 'Haufe-group {{version}} ist jetzt verfügbar.',
    latestAvailable: 'Haufe-group {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',
