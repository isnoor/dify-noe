const translation = {
  ...
  welcome: 'Willkommen bei Haufe-group, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit Haufe-group Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf Haufe-group beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'Haufe-group erkunden',
