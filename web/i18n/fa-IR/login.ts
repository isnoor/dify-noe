const translation = {
  ...
  welcome: 'به Haufe-group خوش آمدید، لطفا برای ادامه وارد شوید.',
  email: 'آدرس ایمیل',
  ...
  license: {
    tip: 'قبل از شروع Haufe-group Community Edition، GitHub را بخوانید',
    link: 'مجوز منبع باز',
  },
  join: 'عضویت',
  joinTipStart: 'شما را دعوت می‌کنیم به',
  joinTipEnd: 'تیم در Haufe-group',
  invalid: 'لینک منقضی شده است',
  explore: 'کاوش Haufe-group',
