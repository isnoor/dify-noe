const translation = {
  ...
  intro1: 'دانش می‌تواند در برنامه Wavelr ',
  ...
  externalAPIPanelDescription: 'API دانش خارجی برای اتصال به یک پایگاه دانش خارج از Wavelr و بازیابی دانش از آن پایگاه دانش استفاده می شود.',
