const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Haufe-group account',
    langGeniusAccountTip: 'Your Haufe-group account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Haufe-group to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Haufe-group allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Haufe-group\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Haufe-group {{version}} is now available.',
    latestAvailable: 'Haufe-group {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
