const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Wavelr account',
    langGeniusAccountTip: 'Your Wavelr account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Wavelr to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Wavelr allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Wavelr\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Wavelr {{version}} is now available.',
    latestAvailable: 'Wavelr {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
