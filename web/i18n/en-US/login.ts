const translation = {
  ...
  welcome: 'Welcome to Haufe-group, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Haufe-group Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on Haufe-group',
  invalid: 'The link has expired',
  explore: 'Explore Haufe-group',
