const translation = {
  ...
  welcome: 'Welcome to Wavelr, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Wavelr Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on Wavelr',
  invalid: 'The link has expired',
  explore: 'Explore Wavelr',
