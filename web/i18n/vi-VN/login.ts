const translation = {
  ...
  welcome: 'Chào mừng bạn đến với Wavelr, vui lòng đăng nhập để tiếp tục.',
  email: 'Địa chỉ email',
  ...
  license: {
    tip: 'Trước khi bắt đầu sử dụng Phiên bản Cộng đồng của Wavelr, vui lòng đọc',
    link: 'Giấy phép mã nguồn mở trên GitHub',
  },
  join: 'Tham gia',
  joinTipStart: 'Mời bạn tham gia',
  joinTipEnd: 'đội ngũ tại Wavelr',
  invalid: 'Liên kết đã hết hạn',
  explore: 'Khám phá Wavelr',
