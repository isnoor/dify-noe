const translation = {
  ...
  welcome: 'Benvenuto su Haufe-group, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare Haufe-group Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su Haufe-group',
  invalid: 'Il link è scaduto',
  explore: 'Esplora Haufe-group',
