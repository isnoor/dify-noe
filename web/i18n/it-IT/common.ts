const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Account Wavelr',
    langGeniusAccountTip: 'Il tuo account Wavelr e i dati utente associati.',
  ...
  members: {
    ...
    invitationSentTip:
      'Invito inviato, e possono accedere a Wavelr per accedere ai dati del tuo team.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Il servizio di hosting OpenAI fornito da Wavelr ti consente di utilizzare modelli come GPT-3.5. Prima che la tua quota di prova sia esaurita, devi configurare altri fornitori di modelli.',
  ...
  apiBasedExtension: {
    title:
      'Le estensioni API forniscono una gestione centralizzata delle API, semplificando la configurazione per un facile utilizzo nelle applicazioni di Wavelr.',
  ...
  about: {
    ...
    nowAvailable: 'Wavelr {{version}} è ora disponibile.',
    latestAvailable: 'Wavelr {{version}} è l\'ultima versione disponibile.',
  },
  appMenus: {
