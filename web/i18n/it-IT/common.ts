const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Account Haufe-group',
    langGeniusAccountTip: 'Il tuo account Haufe-group e i dati utente associati.',
  ...
  members: {
    ...
    invitationSentTip:
      'Invito inviato, e possono accedere a Haufe-group per accedere ai dati del tuo team.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Il servizio di hosting OpenAI fornito da Haufe-group ti consente di utilizzare modelli come GPT-3.5. Prima che la tua quota di prova sia esaurita, devi configurare altri fornitori di modelli.',
  ...
  apiBasedExtension: {
    title:
      'Le estensioni API forniscono una gestione centralizzata delle API, semplificando la configurazione per un facile utilizzo nelle applicazioni di Haufe-group.',
  ...
  about: {
    ...
    nowAvailable: 'Haufe-group {{version}} è ora disponibile.',
    latestAvailable: 'Haufe-group {{version}} è l\'ultima versione disponibile.',
  },
  appMenus: {
