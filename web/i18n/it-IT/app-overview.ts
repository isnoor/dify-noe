const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'O prova la versione cloud di Wavelr con quota gratuita',
  },
  overview: {
    title: 'Panoramica',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip:
            'Aiuta i visitatori a capire i dati raccolti dall\'applicazione, vedi la <privacyPolicyLink>Privacy Policy</privacyPolicyLink> di Wavelr.',
      ...
      embedded: {
        ...
        chromePlugin: 'Installa l\'estensione Chrome di Wavelr Chatbot',
        copied: 'Copiato',
        copy: 'Copia',
      },
      qrcode: {
