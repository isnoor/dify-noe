const translation = {
  ...
  welcome: 'Bine ai venit la Haufe-group, te rugăm să te autentifici pentru a continua.',
  ...
  license: {
    tip: 'Înainte de a începe Haufe-group Community Edition, citește',
    link: 'Licența open-source de pe GitHub',
  },
  join: 'Alătură-te',
  joinTipStart: 'Te invităm să te alături echipei',
  joinTipEnd: 'pe Haufe-group',
  invalid: 'Link-ul a expirat',
  explore: 'Explorează Haufe-group',
