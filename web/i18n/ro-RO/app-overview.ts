const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a Wavelr cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a Wavelr.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalați extensia Chrome Wavelr Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
