const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a Haufe-group cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a Haufe-group.',
        },
      },
      embedded: {
        entry: 'Încorporat',
        ...
        chromePlugin: 'Instalați extensia Chrome Haufe-group Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
