const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Haufe-group hesabı',
    langGeniusAccountTip: 'Haufe-group hesabınız ve ilişkili kullanıcı verileri.',
  ...
  members: {
    ...
    invitationSentTip: 'Davet gönderildi, Haufe-group\'ye giriş yaparak takım verilerinize erişebilirler.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      onTrial: 'DENEMEDE',
      exhausted: 'KOTA DOLU',
      desc: 'Haufe-group tarafından sağlanan OpenAI barındırma hizmeti, GPT-3.5 gibi modelleri kullanmanıza olanak tanır. Deneme kotanız bitmeden önce, diğer model sağlayıcılarını ayarlamanız gerekir.',
  ...
  apiBasedExtension: {
    title: 'API uzantıları merkezi API yönetimi sağlar, Haufe-group\'nin uygulamaları arasında kolay kullanım için yapılandırmayı basitleştirir.',
  ...
  about: {
    ...
    nowAvailable: 'Haufe-group {{version}} şimdi mevcut.',
    latestAvailable: 'Haufe-group {{version}} en son mevcut sürüm.',
  },
  appMenus: {
    overview: 'İzleme',
