const translation = {
  ...
  intro1: 'Bilgi, Wavelr uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, Wavelr dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
