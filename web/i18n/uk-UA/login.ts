const translation = {
  ...
  welcome: 'Ласкаво просимо до Haufe-group, будь ласка, увійдіть, щоб продовжити.',
  ...
  license: {
    tip: 'Перед запуском Haufe-group Community Edition ознайомтеся з ліцензією з відкритим кодом на GitHub',
    link: 'Ліцензія з відкритим кодом',
  },
  join: 'Приєднуйтесь',
  joinTipStart: 'Запрошуємо вас приєднатися',
  joinTipEnd: 'команда Haufe-group',
  invalid: 'Посилання застаріло',
  explore: 'Досліджуйте Haufe-group',
