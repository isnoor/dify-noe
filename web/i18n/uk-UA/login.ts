const translation = {
  ...
  welcome: 'Ласкаво просимо до Wavelr, будь ласка, увійдіть, щоб продовжити.',
  ...
  license: {
    tip: 'Перед запуском Wavelr Community Edition ознайомтеся з ліцензією з відкритим кодом на GitHub',
    link: 'Ліцензія з відкритим кодом',
  },
  join: 'Приєднуйтесь',
  joinTipStart: 'Запрошуємо вас приєднатися',
  joinTipEnd: 'команда Wavelr',
  invalid: 'Посилання застаріло',
  explore: 'Досліджуйте Wavelr',
