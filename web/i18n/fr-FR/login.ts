const translation = {
  ...
  welcome: 'Bienvenue sur Haufe-group, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer Haufe-group Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur Haufe-group',
  invalid: 'Le lien a expiré',
  explore: 'Explorez Haufe-group',
