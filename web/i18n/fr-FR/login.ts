const translation = {
  ...
  welcome: 'Bienvenue sur Wavelr, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer Wavelr Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur Wavelr',
  invalid: 'Le lien a expiré',
  explore: 'Explorez Wavelr',
