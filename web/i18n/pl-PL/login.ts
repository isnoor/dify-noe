const translation = {
  ...
  welcome: 'Witaj w Wavelr, zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej Wavelr, przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na Wavelr',
  invalid: 'Link wygasł',
  explore: 'Odkryj Wavelr',
