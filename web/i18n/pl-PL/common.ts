const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto Wavelr',
    langGeniusAccountTip: 'Twoje konto Wavelr i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do Wavelr, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez Wavelr pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach Wavelr.',
  ...
  about: {
    ...
    nowAvailable: 'Wavelr {{version}} jest teraz dostępny.',
    latestAvailable: 'Wavelr {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
