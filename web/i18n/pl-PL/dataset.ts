const translation = {
  ...
  intro1: 'Wiedzę można zintegrować z aplikacją Wavelr ',
  ...
  externalAPIPanelDescription: 'Interfejs API wiedzy zewnętrznej służy do łączenia się z bazą wiedzy poza Wavelr i pobierania wiedzy z tej bazy wiedzy.',
}
